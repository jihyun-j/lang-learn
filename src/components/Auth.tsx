...
export function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-blue-900 via-primary-blue-800 to-primary-blue-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-accent-green-400/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-blue-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-accent-green-300/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="glass-card rounded-2xl p-8 space-y-6 border border-white/20">
            {error && (
              <div className="bg-red-500/20 border border-red-400/30 text-red-300 px-4 py-3 rounded-lg text-sm backdrop-blur-sm">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full px-3 py-3 glass-card-light rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-green-400 focus:border-transparent text-white placeholder-white/50 transition-all duration-300"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="pl-10 w-full px-3 py-3 glass-card-light rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-green-400 focus:border-transparent text-white bg-transparent"
                    >
                      {nativeLanguageOptions.map(option => (
                        <option key={option.value} value={option.value} className="bg-primary-blue-800 text-white">
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm text-accent-green-300 hover:text-accent-green-200 transition-colors duration-200"
              >
